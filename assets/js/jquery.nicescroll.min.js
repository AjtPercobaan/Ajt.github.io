      ...
      function S(e, o, t, r) {
        T._bind(
          ...
          function (r) {
            ...
            return (
              'mousewheel' == o ? (r.wheelDeltaX && (i.deltaX = -0.025 * r.wheelDeltaX), r.wheelDeltaY && (i.deltaY = -0.025 * r.wheelDeltaY), !i.deltaY && !i.deltaX && (i.deltaY = -0.025 * r.wheelDelta)) : (i.deltaY = r.detail),
              t.call(e, i)
            );
          },
          r
          ...
          if (
            ...
            if (
              (!1 === M.autohidemode
                ...
                ? ((T.autohidedom = n().add(T.rail)), P.isie8 && (T.autohidedom = T.autohidedom.add(T.cursor)), T.railh && (T.autohidedom = T.autohidedom.add(T.railh)), T.railh && P.isie8 && (T.autohidedom = T.autohidedom.add(T.cursorh)))
            ...
            if (
              (P.hasw3ctouch
                ...
                : P.cantouch && (T.bind(T.win, 'touchstart', T.ontouchstart, !1, !0), T.bind(l, 'touchend', T.ontouchend, !1, !0), T.bind(l, 'touchcancel', T.ontouchend, !1, !0), T.delegate(l, 'touchmove', T.ontouchmove, !1, !0)),
          ...
          return (
            ...
            T.railslocked
              ...
              : (T.hidden || (T.rail.visibility || T.showRail(), T.railh && !T.railh.visibility && T.showRailHr()),
                ...
                T.getScrollTop() > T.page.maxh ? T.doScrollTop(T.page.maxh) : ((T.scroll.y = (T.getScrollTop() / T.scrollratio.y) | 0), (T.scroll.x = (T.getScrollLeft() / T.scrollratio.x) | 0), T.cursoractive && T.noticeCursor()),
